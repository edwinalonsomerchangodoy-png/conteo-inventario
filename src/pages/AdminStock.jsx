      ...
      {!tiendaActiva ? (
        ...
        <Card className="p-6">
          <form onSubmit={guardar} className="grid sm:grid-cols-2 gap-4">
            ...
            <Field label="Área / categoría (Mundo)">
              <input
                className={inputClass}
            ...
            <Field label="Categoría (línea, opcional)">
              <input
                className={inputClass}
                value={categoria}
            ...
            <div className="sm:col-span-2 flex items-center gap-3 pt-1">
              <button
                ...
                className="inline-flex items-center gap-2 bg-brand text-white px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-brand-dark transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
                <Save size={16} />
