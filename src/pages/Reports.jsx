...
function badgeInfo(c) {
  ...
  const noCoincidieron =
    c.conteo_1 !== null &&
    c.conteo_1 !== undefined &&
    c.conteo_2 !== null &&
    c.conteo_2 !== undefined &&
    c.conteo_1 !== c.conteo_2
  ...
  switch (estado) {
    ...
    default:
      return {
        ...
        label: noCoincidieron ? `Confirmado${difTexto} · 1º:${c.conteo_1}≠2º:${c.conteo_2}` : `Confirmado${difTexto}`,
      }
  }
}
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-slate-soft text-sm mt-1">
            Las diferencias solo cuentan como confirmadas después de un reconteo, o quedan
            aceptadas directamente si el primer conteo ya coincidía con el sistema.
          </p>
        </div>
        {conteos.length > 0 && (
        ...
        <>
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
            ...
            <Card className="p-4">
              ...
              <p className="text-2xl font-display font-bold code-tag text-signal-dim">{resumen.pendientes}</p>
            </Card>
            <Card className="p-4">
              <p className="text-xs text-slate-soft">Confirmadas</p>
              <p className="text-2xl font-display font-bold code-tag text-bad">{resumen.confirmados}</p>
            </Card>
            <Card className="p-4">
          ...
          {resumen.pendientes > 0 && (
            <div className="text-xs text-signal-dim bg-signal/10 border border-signal/30 rounded-lg px-4 py-3">
              ...
              confirmación en la sección "Pendientes de reconteo".
            </div>
          )}
                  ...
                  {[...conteos].reverse().map((c, i) => {
                    ...
                    return (
                      <tr key={i}>
                        ...
                        <td className="px-4 py-3 text-slate-soft">{c.marca}</td>
